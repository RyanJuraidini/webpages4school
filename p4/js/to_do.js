$(function() {
  ...
  $list = $('ol');                               // Cache the unordered list
...
/*
  $newItemForm.on('submit', function(e) {       // When a new item is submitted
    var text = $('add').val();           // Get value of text input
    ...
    e.preventDefault();                         //prevents user to procede
    }
    
  },false);*/

  // CLICK HANDLING - USES DELEGATION ON <ol> ELEMENT
  $list.on('click', 'li','ol > li:before', function() {
